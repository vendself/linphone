...
void linphone_gtk_use_rfc2833_dtmf_toggled(GtkWidget *w){
	linphone_core_set_use_rfc2833_for_dtmf(linphone_gtk_get_core(),
		gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(w)));
}
...
void linphone_gtk_show_parameters(void){
	...
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(linphone_gtk_get_widget(pb,"dtmf_rfc2833")),
					linphone_core_get_use_rfc2833_for_dtmf(lc));
	/* MUTIMEDIA CONFIG */
